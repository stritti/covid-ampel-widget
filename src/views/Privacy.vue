<template>
  <div>
    <h3><router-link class="nav" to="/">◀</router-link> Datenschutz</h3>
    ...
    <p>Wir erheben und speichern automatisch Informationen in Log Files, die Ihr Browser automatisch an uns übermittelt. Dies sind Browsertyp/ Browserversion, verwendetes Betriebssystem, Referer URL und&nbsp; Uhrzeit der Serveranfrage. Diese Daten sind nicht bestimmten Personen zuordenbar. Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.</p>
