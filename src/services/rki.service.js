...
const BASE_URL = `${SERVER}/RKI_Landkreisdaten/FeatureServer/0`

class RkiService {
  async getIncidence (objectId) {
    const url =
      `${BASE_URL}/query?where=OBJECTID in (${objectId})&outFields=objectId,last_update,cases7_per_100k,EWZ,BEZ,RS,GEN,IBZ,AGS&returnGeometry=false&f=json`
